            ...
            <div
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <h1 class="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Products overview</h1>
                        <p class="mt-3 max-w-2xl text-sm text-slate-300 sm:text-base">
                            Review all products in one place, with the key data needed for quick admin actions.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                        ...
                        <div class="rounded-2xl border border-white/10 bg-white/10 px-5 py-4 backdrop-blur">
                            <p class="text-xs uppercase tracking-[0.2em] text-slate-300">Discounted</p>
                                    ...
                                    <td colspan="9" class="px-6 py-16 text-center">
                                        <div class="mx-auto max-w-md">
                                            ...
                                            <p class="mt-2 text-sm text-slate-500">
                                                Products will appear here once records are available in the database.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
