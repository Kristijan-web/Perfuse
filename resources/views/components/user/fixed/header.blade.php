<header class="border-b border-white/5 bg-[#0a0a0a] text-white">
    <div
        ...
        <a href="#"
            class="shrink-0 font-sans text-[22px] uppercase tracking-[0.08em] text-[#f5f1eb]">
        ...
        <nav class="flex flex-wrap items-center justify-end gap-x-6 gap-y-[18px] text-[16px] leading-none lg:gap-[34px]"
            ...
            <a href="#"
                class="inline-flex items-center gap-[10px] text-white underline decoration-white underline-offset-[5px] transition-opacity duration-200 hover:opacity-75">
                <svg class="h-[19px] w-[19px] shrink-0 fill-none stroke-current stroke-[1.8]" viewBox="0 0 24 24"
                    aria-hidden="true">
